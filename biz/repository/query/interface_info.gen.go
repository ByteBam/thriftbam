...
func newInterfaceInfo(db *gorm.DB, opts ...gen.DOOption) interfaceInfo {
	...
	_interfaceInfo.ID = field.NewString(tableName, "id")
	_interfaceInfo.InterfaceName = field.NewString(tableName, "interface_name")
	_interfaceInfo.URL = field.NewString(tableName, "url")
	_interfaceInfo.Parameter = field.NewString(tableName, "parameter")
	_interfaceInfo.Method = field.NewString(tableName, "method")
	_interfaceInfo.IsDeleted = field.NewInt32(tableName, "is_deleted")
	...
	_interfaceInfo.ModuleID = field.NewString(tableName, "module_id")
	_interfaceInfo.Response = field.NewString(tableName, "response")
...
type interfaceInfo struct {
	interfaceInfoDo interfaceInfoDo

	ALL           field.Asterisk
	ID            field.String
	InterfaceName field.String // 接口名称
	URL           field.String // 接口地址
	Parameter     field.String // 参数
	Method        field.String // 请求方式
	IsDeleted     field.Int32  // 删除状态  1 true  0 false
	CreateTime    field.Time   // 创建时间
	UpdateTime    field.Time   // 更新时间
	ModuleID      field.String // 模块id
	Response      field.String // 响应参数
...
func (i *interfaceInfo) updateTableName(table string) *interfaceInfo {
	...
	i.InterfaceName = field.NewString(table, "interface_name")
	i.URL = field.NewString(table, "url")
	i.Parameter = field.NewString(table, "parameter")
	...
	i.ModuleID = field.NewString(table, "module_id")
	i.Response = field.NewString(table, "response")
...
func (i *interfaceInfo) WithContext(ctx context.Context) IInterfaceInfoDo {
	return i.interfaceInfoDo.WithContext(ctx)
}

func (i interfaceInfo) TableName() string { return i.interfaceInfoDo.TableName() }

func (i interfaceInfo) Alias() string { return i.interfaceInfoDo.Alias() }

func (i interfaceInfo) Columns(cols ...field.Expr) gen.Columns {
	return i.interfaceInfoDo.Columns(cols...)
}
...
func (i *interfaceInfo) fillFieldMap() {
	...
	i.fieldMap["id"] = i.ID
	i.fieldMap["interface_name"] = i.InterfaceName
	i.fieldMap["url"] = i.URL
	i.fieldMap["parameter"] = i.Parameter
	...
	i.fieldMap["module_id"] = i.ModuleID
	i.fieldMap["response"] = i.Response
}
